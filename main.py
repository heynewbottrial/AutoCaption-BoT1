...
try: app_id = int(os.environ.get("app_id", "24262622"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "50831eb3329ed9c0557aa2bc6aa34376")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6260622606:AAF6CzWlP0mrHpcqZZsEMhi-rNyXQLQ5SKs")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{file_name}` 『 Electric Hacker  』")
...
<b>• Developer : [Electric Hacker](https://t.me/Electric_Hacker_Team)
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/Electric_Hacker_Team>Click Here</a></b>
<b>• Source Code : <a href=https://t.me/Electric_Hacker_Bots>Click Here</a></b>"""
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="https://t.me/ElectricHacker"),
...
print("Bot Created By https://t.me/Electric_Hacker_Bots")
